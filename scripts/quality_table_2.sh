...
cd plot/$species_directory;
	...
	then
		...
		Concordance=$(Concordance_V2.py -p $plot -g /home/suu13/projects/areba/Quality_Score/$embl_name.gff3 -g /home/suu13/projects/areba/Quality_Score/$embl_name.all.gff); #check concordance of whole genome for all annotations
